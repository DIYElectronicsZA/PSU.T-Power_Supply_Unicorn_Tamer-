...
class UserDisplayPanel(wx.Panel):
    ...
    def refresh_dropdown(self,event):
        ...
        new_list = self.serial_port.serial_ports_list()
    ...
    def get_range_values(self):
        ...
        UserDisplayPanel.data_object.B(volts2 =UserDisplayPanel.serial_port.volts2, amps2 = UserDisplayPanel.serial_port.amps2, volts =UserDisplayPanel.serial_port.volts, amps = UserDisplayPanel.serial_port.amps )
...
class MyForm(wx.Frame):
    ...
    def __init__(self):
        ...
        setting_panel = wx.Button(self, label= "Settings panel")
        setting_panel.Bind(wx.EVT_BUTTON, self.onSwitchPanels)

        self.sizer = wx.BoxSizer(wx.VERTICAL)
        self.button_sizer = wx.BoxSizer(wx.VERTICAL)
        self.button_sizer.Add(setting_panel,0, wx.EXPAND, 5)
        #self.button_sizer.Add(wx.StaticLine(self), 0,wx.ALL, 5)
